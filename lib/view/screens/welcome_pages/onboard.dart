...
class _OnboardScreenState extends State<OnboardScreen> {
  int curruntPage=0;
      List pageViewDetails=[
    {
      ...
      "title":"Easy Process",
      "text":"Find all your house needs in one place. We provide every service to make your home experience smooth."

    },
    {
      "image":"assets/images/Group.png",
      "title":"Expert People",
      "text":"We have the best in class individuals working just for you. They are well trained and capable of handling anything you need."

    },
    {
      "image":"assets/images/Frame.png",
      "title":"All In One Place",
      "text":"We have all the household services you need on a daily basis with easy access"
          ...
          Padding(
            ...
            child: TextButton(
              onPressed: (){Navigator.pushReplacement(context, 
                   ...
                   child: const Text('Skip',style: TextStyle(color: yallowColor,fontSize: 18,fontWeight: FontWeight.w700),),
                   ),
          ),
        ]
              ...
              child: DefaultButton(
                height: media.height*0.07,
                 width: media.width*0.90,
                  ...
                  text: Text(curruntPage==pageViewDetails.length-1? "Enter":"Next"),
                   funq: (){
                    ...
                    pageViewController.nextPage(duration: Duration(milliseconds: 100),
  ...
  return Column(
    ...
    children: [
      ...
      height: media.height *0.38,
        ...
        Text('${pageViewDetails[index]['title']}',style: const TextStyle(fontSize: 34,fontWeight: FontWeight.w700),),
        Padding(
          padding:  EdgeInsets.all(media.width *0.10),
          child: Text('${pageViewDetails[index]['text']}', textAlign: TextAlign.center,style: const TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
        ),
